...
test("D1 diagnostics redact sensitive stderr at every chunk split", async () => {
  ...
  const cases = [
    ...
    },
    {
      ...
      redacted: "context-before Authorization: [redacted]",
    },
    {
      name: "basic authorization",
      input: "context-before Authorization: Basic QWxhZGRpbjpvcGVuIHNlc2FtZQ==",
      secrets: [],
      forbidden: ["QWxhZGRpbjpvcGVuIHNlc2FtZQ=="],
      expected: "Authorization: [redacted]",
      redacted: "context-before Authorization: [redacted]",
    },
    {
      name: "digest authorization",
      input: 'context-before Authorization: Digest username="synthetic", realm="example", nonce="DIGEST_NONCE_9382", response="DIGEST_RESPONSE_9382"',
      secrets: [],
      forbidden: ["DIGEST_NONCE_9382", "DIGEST_RESPONSE_9382"],
      expected: "Authorization: [redacted]",
      redacted: "context-before Authorization: [redacted]",
    },
    {
      name: "proxy basic authorization",
      input: "context-before Proxy-Authorization: Basic PROXY_BASIC_SECRET_9382",
      secrets: [],
      forbidden: ["PROXY_BASIC_SECRET_9382"],
      expected: "Proxy-Authorization: [redacted]",
      redacted: "context-before Proxy-Authorization: [redacted]",
    },
    {
      name: "custom authorization scheme",
      input: 'context-before Authorization: CustomScheme SPLIT_SCHEME_TOKEN_9382 opaque="SPLIT_SCHEME_TAIL_9382"',
      secrets: [],
      forbidden: ["SPLIT_SCHEME_TOKEN_9382", "SPLIT_SCHEME_TAIL_9382"],
      expected: "Authorization: [redacted]",
      redacted: "context-before Authorization: [redacted]",
    },
    {
