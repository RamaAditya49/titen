...
| Real Cloudflare deployment; live Vectorize/Workers AI | Implemented; Verified live | [Cloudflare guide](./deployment/cloudflare.md), [0.5.5 delivery evidence](./specs/done/2026-08-01-ponytail-zero.md#delivery-evidence) | The retained Rama Digital `titen-test-*` stack proves schema 21, native bindings, scoped BGE-M3/Vectorize retrieval, bounded repair, Cron, auth, persistence, and actual rollback/recovery. It is isolated test production, not customer cutover or extraction-model activation. |
