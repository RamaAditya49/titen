...
| Model-assisted derivation and reflection | Implemented; Verified locally; activation gated | [ADR-0004](./decisions/0004-model-assisted-memory-enrichment.md), [paired work spec](./specs/active/2026-07-31-model-assisted-enrichment-0136.md), [dual-runtime contracts](../tests/contract/enrichment.ts) | Durable jobs/provider/validator are shipped opt-in; locked evaluation and real Cloudflare Paid D1/VPS/local smokes remain required before production activation. |
