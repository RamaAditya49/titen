...
| Model-assisted derivation and reflection | Planned; architecture/evaluation evidence | [ADR-0004](./decisions/0004-model-assisted-memory-enrichment.md), [2026-07-31 pilot](./research/2026-07-31-memory-model-evaluation.md) | Sol is a canary candidate only; no enrichment jobs/provider/validator or three-target runtime smoke has shipped. |
