...
| Replace Wulan Mem0 with Titen | Latest evaluated package 0.4.1: NO-GO | [terminal 0.4.1 gate](./testing/results/2026-08-01-titen-041-replacement-gate/report.md), [historical cycles](./testing/2026-07-31-mem0-replacement-cycle4.md) | The frozen 0.4.1 package failed pre-registered correctness gates. A stable 0.5.0 code or release result does not grant Mem0 cutover authority; replacement needs a new release-bound evaluation. |
